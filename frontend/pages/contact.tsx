...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact - FlavorSnap</title>
        <meta name="description" content="Get in touch with the FlavorSnap team" />
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={6}
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent resize-none ${
